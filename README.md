...
2. **Install in the workflow**: add a step running `claude plugin marketplace add JoeldelPilar/claude-plugins && claude plugin install auto-docs@eyevinn-claude` before invoking the action.
